...
from rednotebook.profiling.stats import is_number, numeric_summary, top_values
...
def profile_result(
    ...
    *,
    ...
    for col in columns:
        ...
        numeric = numeric_summary(values) if any(is_number(v) for v in values) else None
        col_profiles.append(
            ColumnProfile(
                name=col.name,
